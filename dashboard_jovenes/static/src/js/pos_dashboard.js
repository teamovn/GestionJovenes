...
var YoungDashboard = AbstractAction.extend({
    ...
    fetch_data: function() {
      ...
      var def1 =  this._rpc({
         ...
         self.desem_total = result['desem_total']
         self.em_cat = result['em_cat']
...
// FIN DE GRAFICO DE BARRA CIRCULAR

//INICIO DE GRAFICO DE BARRA HIRIZONTAL
...
// FIN DE GRAFICO BARRA HORIZONTAL
     render_product_category_graph:function(){
           var self = this
        var ctx = self.$(".top_product_categories");
            rpc.query({
                model: "young.curriculum.vitae",
                method: "get_gender_empleo", // get_the_top_categories
            }).then(function (arrays) {
